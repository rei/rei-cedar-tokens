...
/**
 * Registers a custom Style Dictionary filter that includes only icon tokens.
 *
 ...
 */
export const componentIconTokens = (sd: typeof StyleDictionary): void => {
  sd.registerFilter({
    name: "component-icon-tokens",
    filter: (token: Token) =>
