 ...
 *
 * This filter includes tokens that are that include input or label namespace while
 ...
 */
export const componentInputTokens = (sd: typeof StyleDictionary): void => {
  sd.registerFilter({
    name: "component-input-tokens",
    filter: (token: Token) =>
