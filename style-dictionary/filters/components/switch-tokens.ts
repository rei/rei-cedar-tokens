 ...
 *
 * This filter includes tokens that are that include switch namespace while
 ...
 */
export const componentSwitchTokens = (sd: typeof StyleDictionary): void => {
  sd.registerFilter({
    name: 'component-switch-tokens',
    filter: (token: Token) =>
