import { componentModulesName, jsFoundationsModulesName } from './modules';

export const typesFilters = () => {
  const filtersFoundations = jsFoundationsModulesName
    .filter((moduleName) => moduleName !== 'color-background')
    .flatMap((moduleName) => [
      {
