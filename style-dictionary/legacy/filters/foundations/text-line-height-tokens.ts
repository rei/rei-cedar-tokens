...
/**
 * Registers a custom Style Dictionary filter that includes only text line height tokens.
 *
 * This filter includes tokens that are in the 'text' namespace including only "line-height" related, while
