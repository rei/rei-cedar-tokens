export interface CdrProminenceTokens {
  /**
   * @value 0 4px 4px 0 rgba(46, 46, 43, 0.2)
   ...
   * @value 4px
   * @cssvar --cdr-prominence-elevated-blur
   */
   ...
   * @cssvar --cdr-prominence-elevated-color
   */
   ...
   * @design Use for elevated surfaces needing medium depth
   * @value 0
   * @cssvar --cdr-prominence-elevated-spread
   */
   ...
   * @design Use for elevated surfaces needing medium depth
   * @value 0
   * @cssvar --cdr-prominence-elevated-x
   */
   ...
   * @value 0
   * @cssvar --cdr-prominence-flat-blur
   */
   ...
   * @design Use for flat surfaces needing minimal depth
   * @value rgba(46, 46, 43, 0.2)
   * @cssvar --cdr-prominence-flat-color
   */
   ...
   * @design Use for flat surfaces needing minimal depth
   * @value 0
   * @cssvar --cdr-prominence-flat-spread
   */
   ...
   * @design Use for flat surfaces needing minimal depth
   * @value 0
   * @cssvar --cdr-prominence-flat-y
   */
  readonly CdrProminenceFlatY: string;
  /**
   * @value 0 8px 8px 0 rgba(46, 46, 43, 0.2)
   ...
   * @value 8px
   * @cssvar --cdr-prominence-floating-blur
   */
   ...
   * @design Use for floating surfaces needing strong depth
   * @value rgba(46, 46, 43, 0.2)
   * @cssvar --cdr-prominence-floating-color
   */
   ...
   * @design Use for floating surfaces needing strong depth
   * @value 0
   * @cssvar --cdr-prominence-floating-spread
   */
   ...
   * @design Use for floating surfaces needing strong depth
   * @value 0
   * @cssvar --cdr-prominence-floating-x
   */
   ...
   * @design Use for floating surfaces needing strong depth
   * @value 8px
   * @cssvar --cdr-prominence-floating-y
   */
  readonly CdrProminenceFloatingY: string;
  /**
   * @value 0 16px 16px 0 rgba(46, 46, 43, 0.2)
   * @cssvar --cdr-prominence-lifted
   */
   ...
   * @value 16px
   * @cssvar --cdr-prominence-lifted-blur
   */
   ...
   * @design Use for lifted surfaces needing dramatic depth
   * @value rgba(46, 46, 43, 0.2)
   * @cssvar --cdr-prominence-lifted-color
   */
   ...
   * @design Use for lifted surfaces needing dramatic depth
   * @value 0
   * @cssvar --cdr-prominence-lifted-spread
   */
   ...
   * @design Use for lifted surfaces needing dramatic depth
   * @value 0
   * @cssvar --cdr-prominence-lifted-x
   */
   ...
   * @design Use for lifted surfaces needing dramatic depth
   * @value 16px
   * @cssvar --cdr-prominence-lifted-y
   */
  readonly CdrProminenceLiftedY: string;
  /**
   * @value 0 2px 2px 0 rgba(46, 46, 43, 0.2)
   * @cssvar --cdr-prominence-raised
   */
   ...
   * @value 2px
   * @cssvar --cdr-prominence-raised-blur
   */
   ...
   * @design Use for raised surfaces needing subtle elevation
   * @value rgba(46, 46, 43, 0.2)
   * @cssvar --cdr-prominence-raised-color
   */
   ...
   * @design Use for raised surfaces needing subtle elevation
   * @value 0
   * @cssvar --cdr-prominence-raised-spread
   */
   ...
   * @design Use for raised surfaces needing subtle elevation
   * @value 0
   * @cssvar --cdr-prominence-raised-x
   */
   ...
   * @design Use for raised surfaces needing subtle elevation
   * @value 2px
   * @cssvar --cdr-prominence-raised-y
   */
