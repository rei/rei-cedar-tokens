export const CdrTable = {
  ...
  CdrKnockoutColorBackgroundTableHeader: "rgba(75, 74, 72, 0.5)",
  CdrKnockoutColorBackgroundTableRow: "#2e2e2b",
  CdrKnockoutColorBorderTableRow: "#4b4a48",
  CdrKnockoutColorTextTablePrimary: "#fafbf9",
  CdrKnockoutColorTextTableSecondary: "#d5cfc3",
};
