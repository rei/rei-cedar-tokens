...
export const HeadingsSans: Story = {
  ...
  render: () =>
    `${chrome}<div class="sb-page">${section("Heading Sans", [
      typeRow(
        "text-heading-sans / 200",
        "CdrTextHeadingSans200",
        "Heading Sans 200",
      ),
      typeRow(
        "text-heading-sans / 300",
        "CdrTextHeadingSans300",
        "Heading Sans 300",
      ),
      typeRow(
        "text-heading-sans / 400",
        "CdrTextHeadingSans400",
        "Heading Sans 400",
      ),
      typeRow(
        "text-heading-sans / 500",
        "CdrTextHeadingSans500",
        "Heading Sans 500",
      ),
      typeRow(
        "text-heading-sans / 600",
        "CdrTextHeadingSans600",
        "Heading Sans 600",
      ),
    ])}</div>`,
};
...
export const HeadingsSerif: Story = {
  ...
  render: () =>
    `${chrome}<div class="sb-page">${section("Heading Serif", [
      typeRow(
        "text-heading-serif / 200",
        "CdrTextHeadingSerif200",
        "Heading Serif 200",
      ),
      typeRow(
      ...
      typeRow(
        "text-heading-serif / 400",
        "CdrTextHeadingSerif400",
        "Heading Serif 400",
      ),
      typeRow(
        "text-heading-serif / 500",
        "CdrTextHeadingSerif500",
        "Heading Serif 500",
      ),
      typeRow(
        "text-heading-serif / 600",
        "CdrTextHeadingSerif600",
        "Heading Serif 600",
      ),
      typeRow(
        "text-heading-serif / 700",
        "CdrTextHeadingSerif700",
        "Heading Serif 700",
      ),
      typeRow(
        "text-heading-serif / 800",
        "CdrTextHeadingSerif800",
        "Heading Serif 800",
      ),
      typeRow(
        "text-heading-serif / 900",
        "CdrTextHeadingSerif900",
        "Heading Serif 900",
      ),
      typeRow(
        "text-heading-serif / 1000",
        "CdrTextHeadingSerif1000",
        "Heading Serif 1000",
      ),
      typeRow(
        "text-heading-serif / 1100",
        "CdrTextHeadingSerif1100",
        "Heading Serif 1100",
      ),
      typeRow(
        "text-heading-serif / 1200",
        "CdrTextHeadingSerif1200",
        "Heading Serif 1200",
      ),
    ])}</div>`,
};
...
export const HeadingsDisplay: Story = {
  ...
  render: () =>
    `${chrome}<div class="sb-page">${section("Heading Display", [
      typeRow(
        "text-heading-display / 800",
        "CdrTextHeadingDisplay800",
        "Display 800",
      ),
      typeRow(
        "text-heading-display / 900",
        "CdrTextHeadingDisplay900",
        "Display 900",
      ),
      typeRow(
        "text-heading-display / 1000",
        "CdrTextHeadingDisplay1000",
        "Display 1000",
      ),
      typeRow(
        "text-heading-display / 1100",
        "CdrTextHeadingDisplay1100",
        "Display 1100",
      ),
      typeRow(
        "text-heading-display / 1200",
        "CdrTextHeadingDisplay1200",
        "Display 1200",
      ),
      typeRow(
        "text-heading-display / 1300",
        "CdrTextHeadingDisplay1300",
        "Display 1300",
      ),
      typeRow(
        "text-heading-display / 1400",
        "CdrTextHeadingDisplay1400",
        "Display 1400",
      ),
      typeRow(
        "text-heading-display / 1500",
        "CdrTextHeadingDisplay1500",
        "Display 1500",
      ),
      typeRow(
        "text-heading-display / 1600",
        "CdrTextHeadingDisplay1600",
        "Display 1600",
      ),
    ])}</div>`,
};
...
export const SubheadingsSans: Story = {
  ...
  render: () =>
    `${chrome}<div class="sb-page">${section("Subheading Sans", [
      typeRow(
        "text-subheading-sans / 300",
        "CdrTextSubheadingSans300",
        "Subheading 300",
      ),
      typeRow(
        "text-subheading-sans / 400",
        "CdrTextSubheadingSans400",
        "Subheading 400",
      ),
      typeRow(
        "text-subheading-sans / 500",
        "CdrTextSubheadingSans500",
        "Subheading 500",
      ),
      typeRow(
  ...
  render: () =>
    `${chrome}<div class="sb-page">
      ...
      ${section("Utility Sans Strong", [
        typeRow(
          "text-utility-sans-strong / 100",
          "CdrTextUtilitySansStrong100",
        ),
        typeRow(
          "text-utility-sans-strong / 200",
          "CdrTextUtilitySansStrong200",
        ),
        typeRow(
          "text-utility-sans-strong / 300",
          "CdrTextUtilitySansStrong300",
        ),
        typeRow(
          "text-utility-sans-strong / 400",
          "CdrTextUtilitySansStrong400",
        ),
        typeRow(
          "text-utility-sans-strong / 500",
          "CdrTextUtilitySansStrong500",
        ),
        typeRow(
          "text-utility-sans-strong / 600",
          "CdrTextUtilitySansStrong600",
        ),
        typeRow(
          "text-utility-sans-strong / 700",
          "CdrTextUtilitySansStrong700",
        ),
        typeRow(
          "text-utility-sans-strong / 800",
          "CdrTextUtilitySansStrong800",
        ),
      ])}
    </div>`,
};
  ...
  render: () =>
    `${chrome}<div class="sb-page">
      ...
      ${section("Utility Serif Strong", [
        typeRow(
          "text-utility-serif-strong / 200",
          "CdrTextUtilitySerifStrong200",
        ),
        typeRow(
          "text-utility-serif-strong / 300",
          "CdrTextUtilitySerifStrong300",
        ),
        typeRow(
          "text-utility-serif-strong / 400",
          "CdrTextUtilitySerifStrong400",
        ),
        typeRow(
          "text-utility-serif-strong / 500",
          "CdrTextUtilitySerifStrong500",
        ),
        typeRow(
          "text-utility-serif-strong / 600",
          "CdrTextUtilitySerifStrong600",
        ),
        typeRow(
          "text-utility-serif-strong / 700",
          "CdrTextUtilitySerifStrong700",
        ),
        typeRow(
          "text-utility-serif-strong / 800",
          "CdrTextUtilitySerifStrong800",
        ),
      ])}
    </div>`,
};
...
export const FluidTypeScale: Story = {
  ...
  render: () => {
    const t = tokens as Record<string, string>;
    const scaleKeys = Object.keys(t).filter((k) =>
      k.startsWith("CdrTypeScale"),
    );
