try {
  (() => {
    ...
    var _n = __STORYBOOK_COMPONENTS__,
      {
        A: Tn,
        ActionBar: we,
        AddonPanel: vn,
        ...
        codeCommon: Sa,
        components: Ra,
        createCopyToClipboardFunction: Aa,
        getStoryHref: Ca,
        icons: Na,
        interleaveSeparators: wa,
        nameSpaceClassNames: xa,
        resetComponents: La,
        withReset: Ia,
      } = __STORYBOOK_COMPONENTS__;
    var Fa = __STORYBOOK_CORE_EVENTS__,
      {
        ARGTYPES_INFO_REQUEST: Ha,
        ARGTYPES_INFO_RESPONSE: Ua,
        CHANNEL_CREATED: za,
        CHANNEL_WS_DISCONNECT: ja,
        CONFIG_ERROR: ka,
        CREATE_NEW_STORYFILE_REQUEST: Ga,
        CREATE_NEW_STORYFILE_RESPONSE: Wa,
        CURRENT_STORY_WAS_SET: Va,
        DOCS_PREPARED: $a,
        DOCS_RENDERED: Ya,
        ...
        GLOBALS_UPDATED: Ka,
        NAVIGATE_URL: Qa,
        PLAY_FUNCTION_THREW_EXCEPTION: eo,
        PRELOAD_ENTRIES: to,
        PREVIEW_BUILDER_PROGRESS: ro,
        PREVIEW_KEYDOWN: no,
        REGISTER_SUBSCRIPTION: ao,
        REQUEST_WHATS_NEW_DATA: oo,
        RESET_STORY_ARGS: io,
        RESULT_WHATS_NEW_DATA: so,
        SAVE_STORY_REQUEST: lo,
        SAVE_STORY_RESPONSE: uo,
        SELECT_STORY: co,
        SET_CONFIG: po,
        SET_CURRENT_STORY: fo,
        SET_FILTER: mo,
        SET_GLOBALS: bo,
        SET_INDEX: go,
        SET_STORIES: ho,
        SET_WHATS_NEW_CACHE: Eo,
        SHARED_STATE_CHANGED: yo,
        SHARED_STATE_SET: Oo,
        STORIES_COLLAPSE_ALL: _o,
        STORIES_EXPAND_ALL: To,
        STORY_ARGS_UPDATED: vo,
        STORY_CHANGED: k,
        STORY_ERRORED: So,
        STORY_FINISHED: Ro,
        STORY_INDEX_INVALIDATED: Ao,
        STORY_MISSING: Co,
        STORY_PREPARED: No,
        STORY_RENDERED: wo,
        STORY_RENDER_PHASE_CHANGED: xo,
        STORY_SPECIFIED: Lo,
        STORY_THREW_EXCEPTION: Io,
        STORY_UNCHANGED: Do,
        TELEMETRY_ERROR: Mo,
        TESTING_MODULE_CANCEL_TEST_RUN_REQUEST: Po,
        TESTING_MODULE_CANCEL_TEST_RUN_RESPONSE: Bo,
        TESTING_MODULE_CRASH_REPORT: Fo,
        TESTING_MODULE_PROGRESS_REPORT: Ho,
        TESTING_MODULE_RUN_ALL_REQUEST: Uo,
        TESTING_MODULE_RUN_REQUEST: zo,
        TOGGLE_WHATS_NEW_NOTIFICATIONS: jo,
        UNHANDLED_ERRORS_WHILE_PLAYING: ko,
        UPDATE_GLOBALS: Go,
        UPDATE_QUERY_PARAMS: Wo,
        UPDATE_STORY_ARGS: Vo,
      } = __STORYBOOK_CORE_EVENTS__;
    var ti = __STORYBOOK_API__,
      {
        ActiveTabs: ri,
        Consumer: ni,
        ManagerContext: ai,
        Provider: oi,
        RequestResponseError: ii,
        addons: Q,
        combineParameters: si,
        controlOrMetaKey: li,
        controlOrMetaSymbol: ui,
        eventMatchesShortcut: ci,
        eventToShortcut: pi,
        experimental_MockUniversalStore: di,
        experimental_UniversalStore: fi,
        experimental_requestResponse: mi,
        experimental_useUniversalStore: bi,
        isMacLike: gi,
        isShortcutTaken: hi,
        keyToSymbol: Ei,
        merge: yi,
    ...
    var dt = function (t) {
        return function (r, n) {
          ...
          var a = r,
            i = n;
          if (typeof r == "string") {
            if (!Ge(r, "px")) throw new T(69, t, r);
            a = We(r);
          }
          if (typeof n == "string") {
            if (!Ge(n, "px")) throw new T(70, t, n);
            i = We(n);
          }
          if (typeof a == "string") throw new T(71, r, t);
    ...
    function F(e, t, r, n) {
      if ((n === void 0 && (n = ft), t === 0)) return n(r, r, r);
    ...
    function I(e) {
      ...
      var d = _t.exec(t.substring(0, 50));
      if (d) {
        var E = parseInt("" + d[1], 10),
          m = parseInt("" + d[2], 10) / 100,
          y = parseInt("" + d[3], 10) / 100,
          O = "rgb(" + F(E, m, y) + ")",
          w = re.exec(O);
        if (!w) throw new T(4, t, O);
        return {
          red: parseInt("" + w[1], 10),
    ...
    function oe(e, t, r) {
      if (typeof e == "number" && typeof t == "number" && typeof r == "number")
        return ae("#" + N(e) + N(t) + N(r));
      if (typeof e == "object" && t === void 0 && r === void 0)
        return ae("#" + N(e.red) + N(e.green) + N(e.blue));
      throw new T(6);
    }
    function $(e, t, r, n) {
    ...
    function Lt(e, t) {
      ...
      var r = A(t);
      return C(_({}, r, { hue: r.hue + parseFloat(e) }));
    }
    var bl = v(Lt);
    function D(e, t, r) {
    ...
    function It(e, t) {
      if (t === "transparent") return t;
      var r = A(t);
      return C(_({}, r, { lightness: D(0, 1, r.lightness - parseFloat(e)) }));
    }
    var gl = v(It);
    function Dt(e, t) {
      if (t === "transparent") return t;
      var r = A(t);
      return C(_({}, r, { saturation: D(0, 1, r.saturation - parseFloat(e)) }));
    }
    var hl = v(Dt);
    function Mt(e, t) {
      if (t === "transparent") return t;
    ...
    function Pt(e, t, r) {
      ...
      if (e === 0) return r;
      var n = I(t),
        a = _({}, n, { alpha: typeof n.alpha == "number" ? n.alpha : 1 }),
        i = I(r),
        s = _({}, i, { alpha: typeof i.alpha == "number" ? i.alpha : 1 }),
        l = a.alpha - s.alpha,
        u = parseFloat(e) * 2 - 1,
        c = u * l === -1 ? u : u + l,
        p = 1 + u * l,
        ...
        d = 1 - f,
        E = {
          red: Math.floor(a.red * f + s.red * d),
          green: Math.floor(a.green * f + s.green * d),
          blue: Math.floor(a.blue * f + s.blue * d),
    ...
    function Ft(e, t) {
      ...
      var r = I(t),
        ...
        a = _({}, r, { alpha: D(0, 1, (n * 100 + parseFloat(e) * 100) / 100) });
      return $(a);
    }
    var Ht = v(Ft),
      qe = Ht;
    ...
    var yl = v(Ut);
    function zt(e, t) {
      return t === "transparent" ? t : C(_({}, A(t), { hue: parseFloat(e) }));
    }
    var Ol = v(zt);
    function jt(e, t) {
      return t === "transparent"
        ? t
        : C(_({}, A(t), { lightness: parseFloat(e) }));
    }
    var _l = v(jt);
    function kt(e, t) {
      return t === "transparent"
        ? t
        : C(_({}, A(t), { saturation: parseFloat(e) }));
    }
    var Tl = v(kt);
    function Gt(e, t) {
          ...
          i.forEach((l) => {
            let u = l.split("."),
              c = (p, f, d) => {
                ...
                let E = u[d];
                if (d === 0) J(p, t) && (E === X || E === Xe) && c(p, X, d + 1);
                else if (E === Xe)
    ...
    var ce = ({ data: e }) => {
      ...
      pr = ({ name: e, data: t }) =>
        typeof e == "string"
          ...
          : o.createElement(ce, { data: t }),
      dr = ({ name: e, data: t, isNonenumerable: r = !1 }) => {
        let n = t;
        return o.createElement(
          "span",
          null,
      ...
      mr = ({ depth: e, name: t, data: r, isNonenumerable: n }) =>
        e === 0
          ...
          : o.createElement(dr, { name: t, data: r, isNonenumerable: n }),
      br = ({
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Tr = ({ data: e, columns: t }) => {
        ...
        let { rowHeaders: p, colHeaders: f } = hr(e);
        t !== void 0 && (f = t);
        let d = p.map((m) => e[m]),
          E;
        if (
        ...
        return o.createElement(
          ...
          o.createElement(Er, { rows: p, columns: f, rowsData: d }),
        );
      },
      vr = fe(Tr),
      Sr = 80,
      ...
      wr = (e) =>
        o.createElement(ot, { nodeRenderer: Cr, dataIterator: Nr, ...e }),
      xr = fe(wr),
      Lr = er(nr()),
      ...
      return (
        ...
        o.createElement(
          ...
          o.createElement(
            ...
            e === 0 ? "" : o.createElement(xe, { status: "neutral" }, e),
          ),
        )
      );
    }
    Q.register(U, (e) => {
      Q.add(Yt, {
        title: jr,
        type: De.PANEL,
        render: ({ active: t }) => o.createElement(zr, { api: e, active: !!t }),
        paramKey: $t,
      });
    });
  })();
