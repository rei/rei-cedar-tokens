...
function A(e, t, { width: o, height: l }) {
  ...
  ((e.width = Math.floor(o * i)),
    (e.height = Math.floor(l * i)),
    t.scale(i, i));
}
var h = {};
function U() {
...
function Z() {
  ...
  (A(h.canvas, h.context, { width: e, height: t }),
    (h.width = e),
    (h.height = t));
}
function J() {
...
function X(e, t, { x: o, y: l, w: i, h: n }, r) {
  return (
    W(e, { x: o, y: l, w: i, h: n, r: 3 }),
    (e.fillStyle = `${w[t]}dd`),
    e.fill(),
    (e.strokeStyle = w[t]),
    e.stroke(),
...
function E(e, t, o, l) {
  ...
  o.forEach((n, r) => {
    let f =
      l && n.position === "center" ? lt(e, t, n) : ot(e, t, n, i[r - 1], l);
    i[r] = f;
  });
}
function nt(e, t, o, l) {
...
var gt = (e, t) => {
    let o = d.document.elementFromPoint(e, t),
      l = (i) => {
        if (i && i.shadowRoot) {
