      ...
      (function (r, o) {
        (function (s, p) {
          ...
          class m extends Error {
            constructor(t, n) {
              let a = `Unexpected type: '${t.type}'.`;
              (n !== void 0 && (a += ` Message: ${n}`),
                super(a),
          ...
          const $ = /^(NaN|-?((\d*\.\d+|\d+)([Ee][+-]?\d+)?|Infinity))/;
          function C(e) {
            var t, n;
            return (n =
              (t = $.exec(e)) === null || t === void 0 ? void 0 : t[0]) !==
              null && n !== void 0
              ? n
              : null;
          }
          ...
          function P(e) {
            ...
            if (
              ...
              e.type === "JsdocTypeTypeParameter"
            )
              throw new m(e);
            return e;
          }
          function re(e) {
            return e.type === "JsdocTypeKeyValue" ? G(e) : P(e);
          }
          function bt(e) {
            return e.type === "JsdocTypeName" ? e : G(e);
          }
          function G(e) {
          ...
          function xt(e) {
            ...
            if (e.type === "JsdocTypeVariadic") {
              if (
                ((t = e.element) === null || t === void 0 ? void 0 : t.type) ===
                "JsdocTypeName"
              )
                return e;
              throw new m(e);
          ...
          class U {
            ...
            parseInfixIntermediateType(t, n) {
              let a = this.tryParslets(t, n);
              for (; a !== null; ) ((t = a), (a = this.tryParslets(t, n)));
              return t;
            }
            tryParslets(t, n) {
              for (const a of this.grammar) {
                const i = a(this, n, t);
                if (i !== null) return i;
              }
              return null;
            ...
            consume(t) {
              return (
                Array.isArray(t) || (t = [t]),
                t.includes(this.lexer.current.type)
          ...
          function h(e) {
            const t = (n, a, i) => {
              const l = n.lexer.current.type,
                f = n.lexer.next.type;
              if (i === null) {
                if ("parsePrefix" in e && e.accept(l, f))
          ...
          function At({ allowTrailingComma: e }) {
            return h({
              ...
              parseInfix: (t, n) => {
                ...
                if (
                  a.length > 0 &&
                  a.slice(0, -1).some((i) => i.type === "JsdocTypeVariadic")
                )
                  throw new Error(
                    "Only the last parameter may be a rest parameter",
                  );
                return { type: "JsdocTypeParameterList", elements: a };
              },
            });
          }
          const vt = h({
              ...
              parseInfix: (e, t) => {
                ...
                return Object.assign(
                  Object.assign(
                    { type: "JsdocTypeGeneric", left: P(t), elements: a },
                    i ? { infer: !0 } : {},
                  ),
                  { meta: { brackets: "angle", dot: n } },
                );
              },
            }),
            Rt = h({
          ...
          function Q({
            ...
            return function (i, l, f) {
              ...
              i.consume(".")
                ? (S = "property")
                : i.consume("[")
                  ? ((S = "property-brackets"), (Z = !0))
                  : i.consume("~")
                    ? (S = "inner")
                    : (i.consume("#"), (S = "instance"));
              const Le = n !== null ? new U(n, i.lexer, i) : i,
              ...
              switch (I.type) {
                ...
                case "JsdocTypeStringValue":
                  q = {
                    type: "JsdocTypeProperty",
                    value: I.value,
                    meta: { quote: I.meta.quote },
                  };
                  break;
                case "JsdocTypeSpecialNamePath":
                  if (I.specialType === "event") q = I;
                  else
                    throw new m(
                      I,
          ...
          function A({ allowedAdditionalTokens: e }) {
            return h({
              ...
              accept: (t) =>
                ...
                e.includes(t),
              parsePrefix: (t) => {
                const { type: n, text: a } = t.lexer.current;
                return (t.consume(n), { type: "JsdocTypeName", value: a });
              },
            });
          }
          const D = h({
          ...
          const xe = [
            ...
            j = [...xe, H({ allowedTypes: ["event"], pathGrammar: xe })];
          function ie(e) {
            let t;
          ...
          function ce({
            ...
            allowNewAsFunctionKeyword: a,
          }) {
            return h({
              name: "functionParslet",
              accept: (i, l) =>
                i === "function" || (a && i === "new" && l === "("),
              parsePrefix: (i) => {
                const l = i.consume("new");
                i.consume("function");
                const f = i.lexer.current.type === "(";
                if (!f) {
                  if (!n) throw new Error("function is missing parameter list");
                ...
                if (!n.consume("}")) {
                  ...
                  for (;;) {
                    ...
                    (n.acceptLexerState(l),
                      f === void 0 &&
                        t &&
                        (f = n.parseIntermediateType(y.OBJECT)));
                    let g = !1;
                    if (
                      (f.type === "JsdocTypeNullable" &&
                        ((g = !0), (f = f.element)),
                      f.type === "JsdocTypeNumber" ||
                    ...
                    if (n.lexer.current.startOfLine)
                      ((i = "linebreak"), n.consume(",") || n.consume(";"));
                    else if (n.consume(",")) i = "comma";
                    else if (n.consume(";")) i = "semicolon";
                    else break;
                    if (n.lexer.current.type === "}") break;
                  }
                  if (
                    ((a.meta.separator = i ?? "comma"),
                    i === "linebreak" && (a.meta.propertyIndent = "  "),
                    !n.consume("}"))
                  )
            ...
            Ie = h({
              ...
              parsePrefix: (e) => (
                e.consume("typeof"),
                {
                  ...
                  element: e.parseType(y.KEY_OF_TYPE_OF),
                }
              ),
            }),
            Ft = [
          ...
          function jt({ allowQuestionMark: e }) {
            return h({
              name: "tupleParslet",
              accept: (t) => t === "[",
              parsePrefix: (t) => {
                ...
                if (
                  (a.type === "JsdocTypeParameterList"
                    ? a.elements[0].type === "JsdocTypeKeyValue"
                      ? (n.elements = a.elements.map(G))
                      : (n.elements = a.elements.map(P))
                ...
                if (n.elements.some((i) => i.type === "JsdocTypeUnknown"))
          ...
          const $t = h({
              ...
              parsePrefix: (e) => (
                ...
                {
                  type: "JsdocTypeKeyof",
                  element: P(e.parseType(y.KEY_OF_TYPE_OF)),
                }
              ),
            }),
            Kt = h({
            ...
            Yt = h({
              ...
              parsePrefix: (e) => {
                ...
                let n;
                if (e.consume(":")) {
                  const a = e.baseParser;
                  (a.acceptLexerState(e),
                    (n = {
            ...
            Gt = h({
              ...
              parsePrefix: (e) => (
                e.consume("readonly"),
                {
                  ...
                  element: kt(e.parseIntermediateType(y.ALL)),
                }
              ),
            }),
            Xt = h({
          ...
          function Ht(e, t = ["typescript", "closure", "jsdoc"]) {
            let n;
            for (const a of t)
              try {
                return Ae(e, a);
          ...
          function M(e, t) {
            ...
            if (n === void 0)
              throw new Error(
                `In this set of transform rules exists no rule for type ${t.type}.`,
              );
            return n(t, (a) => M(e, a));
          }
          function w(e) {
            ...
            return {
              ...
              JsdocTypeFunction: (e, t) => {
                ...
                if (e.arrow) {
                  ...
                  let a = `${e.typeParameters !== void 0 ? `<${(n = e.typeParameters.map(t).join(", ")) !== null && n !== void 0 ? n : ""}>` : ""}(${e.parameters.map(t).join(", ")}) => ${t(e.returnType)}`;
                  return (e.constructor && (a = "new " + a), a);
                } else {
                  let a = e.constructor ? "new" : "function";
                  return (
                    e.parenthesis &&
                      ((a += `(${e.parameters.map(t).join(", ")})`),
                      e.returnType !== void 0 && (a += `: ${t(e.returnType)}`)),
                    a
                  );
                }
              },
              ...
              JsdocTypeStringValue: (e) => v(e.value, e.meta.quote),
              JsdocTypeAny: () => "*",
              JsdocTypeGeneric: (e, t) => {
                if (e.meta.brackets === "square") {
                  const n = e.elements[0],
                    a = t(n);
                  return n.type === "JsdocTypeUnion" ||
                    n.type === "JsdocTypeIntersection"
                    ? `(${a})[]`
                    : `${a}[]`;
                } else
                  return `${t(e.left)}${e.meta.dot ? "." : ""}<${e.infer === !0 ? "infer " : ""}${e.elements.map(t).join(", ")}>`;
              },
              ...
              JsdocTypeObjectField: (e, t) => {
                ...
                return (
                  ...
                  typeof e.key == "string"
                    ? (n += v(e.key, e.meta.quote))
                    : (n += t(e.key)),
                  e.optional && (n += "?"),
                  e.right === void 0 ? n : n + `: ${t(e.right)}`
                );
              },
              ...
              JsdocTypeObject: (e, t) => {
                var n, a;
                return `{${
                  (e.meta.separator === "linebreak" && e.elements.length > 1
                    ? `
` + ((n = e.meta.propertyIndent) !== null && n !== void 0 ? n : "")
                    : "") +
                  e.elements.map(t).join(
                    e.meta.separator === "comma"
                      ? ", "
                      : e.meta.separator === "linebreak"
                        ? `
` + ((a = e.meta.propertyIndent) !== null && a !== void 0 ? a : "")
                        : "; ",
                  ) +
                  (e.meta.separator === "linebreak" && e.elements.length > 1
                    ? `
`
              ...
              JsdocTypeProperty: (e) => v(e.value, e.meta.quote),
              ...
              JsdocTypeAsserts: (e, t) =>
                `asserts ${t(e.left)} is ${t(e.right)}`,
              JsdocTypeReadonlyArray: (e, t) => `readonly ${t(e.element)}`,
              JsdocTypeAssertsPlain: (e, t) => `asserts ${t(e.element)}`,
              JsdocTypeConditional: (e, t) =>
                `${t(e.checksType)} extends ${t(e.extendsType)} ? ${t(e.trueType)} : ${t(e.falseType)}`,
              JsdocTypeTypeParameter: (e, t) =>
          ...
          const tn = {
            ...
            JsdocTypeStringValue: (e) => R(v(e.value, e.meta.quote)),
            ...
            JsdocTypeFunction: (e, t) => {
              ...
              return (
                ...
                n.new !== void 0 && (a.new = t(n.new)),
                e.returnType !== void 0 && (a.result = t(e.returnType)),
                a
              );
            },
            JsdocTypeGeneric: (e, t) => ({
            ...
            JsdocTypeSpecialNamePath: (e) =>
              R(e.specialType + ":" + v(e.value, e.meta.quote)),
            JsdocTypeName: (e) =>
              e.value !== "function"
                ? R(e.value)
            ...
            JsdocTypeObject: (e, t) => {
              const n = { type: "RecordType", fields: [] };
            ...
            JsdocTypeNamePath: (e, t) => {
              ...
              e.right.type === "JsdocTypeSpecialNamePath"
                ? (a = t(e.right).name)
                : (a = v(e.right.value, e.right.meta.quote));
              const i =
                e.pathType === "inner"
                  ? "~"
                  : e.pathType === "instance"
            ...
            JsdocTypeSymbol: (e) => {
              let t = "",
                ...
                a = !1;
              return (
                n?.type === "JsdocTypeVariadic" &&
                  (n.meta.position === "prefix" ? (t = "...") : (a = !0),
                  (n = n.element)),
                n?.type === "JsdocTypeName"
                  ? (t += n.value)
                  : n?.type === "JsdocTypeNumber" && (t += n.value.toString()),
                a && (t += "..."),
                R(`${e.value}(${t})`)
              );
            },
            JsdocTypeParenthesis: (e, t) => t(P(e.element)),
            JsdocTypeMappedType: w,
            JsdocTypeIndexSignature: w,
            JsdocTypeImport: w,
            JsdocTypeKeyof: w,
            JsdocTypeTuple: w,
            JsdocTypeTypeof: w,
            JsdocTypeIntersection: w,
            JsdocTypeProperty: w,
            JsdocTypePredicate: w,
            JsdocTypeAsserts: w,
            JsdocTypeReadonlyArray: w,
            JsdocTypeAssertsPlain: w,
          ...
          const on = {
            ...
            JsdocTypeFunction: (e, t) => {
              ...
              return (
                n.this !== void 0
                  ...
                  : e.arrow || (a.this = null),
                n.new !== void 0 && (a.new = t(n.new)),
                e.returnType !== void 0 && (a.returns = t(e.returnType)),
                a
              );
            },
            JsdocTypeGeneric: (e, t) => {
              ...
              return (
                e.meta.brackets === "square" &&
                  ...
                  (n.objects[0] = { type: "NAME", name: "function" }),
                n
              );
            },
            JsdocTypeObjectField: (e, t) => {
            ...
            JsdocTypeIntersection: (e, t) =>
              de("INTERSECTION", e.elements.map(t)),
            JsdocTypeNumber: (e) => ({
              type: "NUMBER_VALUE",
          ...
          function sn() {
            return {
              ...
              JsdocTypeSymbol: (e, t) => {
                const n = { type: "JsdocTypeSymbol", value: e.value };
              ...
              JsdocTypeFunction: (e, t) => {
                ...
                return (
                  e.returnType !== void 0 && (n.returnType = t(e.returnType)),
                  n
                );
              },
              JsdocTypeKeyof: (e, t) => ({
              ...
              JsdocTypeReadonlyArray: (e, t) => ({
                type: "JsdocTypeReadonlyArray",
                element: t(e.element),
              }),
              JsdocTypeAssertsPlain: (e, t) => ({
                type: "JsdocTypeAssertsPlain",
                element: t(e.element),
              }),
              JsdocTypeConditional: (e, t) => ({
                type: "JsdocTypeConditional",
                checksType: t(e.checksType),
                extendsType: t(e.extendsType),
                trueType: t(e.trueType),
                falseType: t(e.falseType),
              }),
              JsdocTypeTypeParameter: (e, t) => ({
                type: "JsdocTypeTypeParameter",
                name: t(e.name),
                constraint: e.constraint !== void 0 ? t(e.constraint) : void 0,
                defaultValue:
                  e.defaultValue !== void 0 ? t(e.defaultValue) : void 0,
              }),
            };
          }
          const _e = {
          ...
          function me(e, t, n, a, i) {
            ...
            for (const f of l) {
              const g = e[f];
              if (g !== void 0)
                if (Array.isArray(g)) for (const k of g) me(k, e, f, a, i);
                else me(g, e, f, a, i);
            }
            i?.(e, t, n);
          }
...
var fe = pn(),
  ...
  c = (r, o) => un(r, "name", { value: o, configurable: !0 });
const { UnknownArgTypesError: Un } =
...
const { UnknownArgTypesError: jn } =
  __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var dn = ["null", "undefined"];
function ee(r) {
  return dn.some((o) => o === r);
}
...
c(fn, "isValidDocgenSection");
function Tn(r, o) {
  return Te(r) ? r.__docgenInfo[o] : null;
}
c(Tn, "getDocgenSection");
function Ue(r) {
  return Te(r) ? mn(r.__docgenInfo.description) : "";
}
...
function qe({ fence: r = "```" } = {}) {
  ...
  return c(function (p) {
    let d = [[]],
      u = !1;
    for (let m of p)
      (hn.test(m.tokens.description) && !u
        ? d.push([m])
        : d[d.length - 1].push(m),
...
function Ge() {
  return (r) => {
    ...
    return s === null
      ...
      : ((o.tag = s[1]),
        (o.postTag = s[3]),
        (o.description = o.description.slice(s[0].length)),
        (r.tag = s[2]),
        r);
  };
}
...
c(We, "getJoiner");
var gn = c((r) => r && r.startsWith('"') && r.endsWith('"'), "isQuoted");
function Qe() {
  ...
  return (o) => {
    ...
    if (m[0] === "[" && m[m.length - 1] === "]") {
      ...
      if (
        ((m = b[0].trim()),
        b[1] !== void 0 && (J = b.slice(1).join("=").trim()),
        m === "")
      )
        return (
          o.problems.push({
...
c(ze, "compactJoiner");
var wn = c((r, { tokens: o }, s) => (o.type === "" ? r : s), "lineNo"),
  Pn = c(
    ({ tokens: r }) =>
...
function et({
  ...
  spacing: s = "compact",
  markers: p = _,
  tokenizers: d = [Ge(), Xe(s), Qe(), He(s)],
} = {}) {
  if (r < 0 || r % 1 > 0) throw new Error("Invalid startLine");
  let u = Ce({ startLine: r, markers: p }),
    m = qe({ fence: o }),
    T = Ye({ tokenizers: d }),
    J = he(s);
  return function (O) {
    ...
    for (let te of Ke(O)) {
      ...
      b.push({
        ...
        tags: Y,
        source: $,
        problems: Y.reduce((N, ne) => N.concat(ne.problems), []),
      });
    }
    return b;
  };
...
var L = fe.stringifyRules(),
  xn = L.JsdocTypeObject;
L.JsdocTypeAny = () => "any";
L.JsdocTypeObject = (r, o) => `(${xn(r, o)})`;
...
c(Sn, "createDefaultValue");
function In({ tsType: r, required: o }) {
  if (r == null) return null;
  let s = r.name;
  return (
    o || (s = s.replace(" | undefined", "")),
    ...
    ? r.name === "string"
      ...
      : r.name === "enum"
        ? Array.isArray(r.value) &&
          r.value.every(
            ({ value: o }) =>
              typeof o == "string" && o[0] === '"' && o[o.length - 1] === '"',
          )
        : !1
    : !1;
}
...
c(vn, "applyJsDocResult");
function Rn(r, o, s, p) {
  let d = bn(o.description);
...
c(_n, "extractComponentDescription");
const { combineParameters: Ln } = __STORYBOOK_MODULE_PREVIEW_API__;
var $n = c((r) => {
    let {
        component: o,
        argTypes: s,
